class Grafica_de_barras:
    ...
    def dibujar (self,intervalos, nombre_archivo_final):
        ...
        with open(nombre_archivo_final, 'a', encoding='utf-8') as f:
             f.write(" "+" ".center(espacio_inter," ")+("\u2517")+((("\u2501")+('\u253B')+('\u2501')+("\u2533")+('\u2501')+('\u253B')).center(espacio,"\u2501"))*(len(lista_acomodar))+" ".center(espacio_inter+1," ")+""+ '\n')
        ...
        with open(nombre_archivo_final, 'a', encoding='utf-8') as f:
            f.write(""+" ".center(espacio_inter+2,"\u2800")+linea_intervalos+" ".center(espacio_inter+1,"\u2800")+""+ '\n')
